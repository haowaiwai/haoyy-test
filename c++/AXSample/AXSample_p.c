...
#define PROC_FORMAT_STRING_SIZE   443                               
...
/* Object interface: IAXSampleCtl, ver. 0.0,
   GUID={0x1E03BF60,0x02DB,0x4587,{0xB7,0x93,0xC4,0xEE,0x48,0x27,0x9A,0xA9}} */


extern const MIDL_STUB_DESC Object_StubDesc;


extern const MIDL_SERVER_INFO IAXSampleCtl_ServerInfo;

#pragma code_seg(".orpc")
static const unsigned short IAXSampleCtl_FormatStringOffsetTable[] = 
    {
    (unsigned short) -1,
    (unsigned short) -1,
    (unsigned short) -1,
...
static const MIDL_SERVER_INFO IAXSampleCtl_ServerInfo = 
    {
    &Object_StubDesc,
    0,
    __MIDL_ProcFormatString.Format,
    &IAXSampleCtl_FormatStringOffsetTable[-3],
    0,
    0,
    0,
    0
...
static const MIDL_STUBLESS_PROXY_INFO IAXSampleCtl_ProxyInfo =
    {
    &Object_StubDesc,
    __MIDL_ProcFormatString.Format,
    &IAXSampleCtl_FormatStringOffsetTable[-3],
...
CINTERFACE_PROXY_VTABLE(20) _IAXSampleCtlProxyVtbl = 
{
    &IAXSampleCtl_ProxyInfo,
    &IID_IAXSampleCtl,
    ...
    (void *)-1 /* IAXSampleCtl::get */ ,
    (void *)-1 /* IAXSampleCtl::get_PicFile */ ,
    (void *)-1 /* IAXSampleCtl::put_PicFile */ ,
    (void *)-1 /* IAXSampleCtl::get_PicPath */ ,
    (void *)-1 /* IAXSampleCtl::put_PicPath */ ,
    (void *)-1 /* IAXSampleCtl::GetPicPath */ ,
    (void *)-1 /* IAXSampleCtl::SetPicPath */ ,
    (void *)-1 /* IAXSampleCtl::SearchFile */ ,
    (void *)-1 /* IAXSampleCtl::Start */ ,
    (void *)-1 /* IAXSampleCtl::test */ ,
    (void *)-1 /* IAXSampleCtl::GetFileList */ ,
    (void *)-1 /* IAXSampleCtl::get_OnChange */ ,
    (void *)-1 /* IAXSampleCtl::put_OnChange */
};


static const PRPC_STUB_FUNCTION IAXSampleCtl_table[] =
{
...
CInterfaceStubVtbl _IAXSampleCtlStubVtbl =
{
    &IID_IAXSampleCtl,
    &IAXSampleCtl_ServerInfo,
    20,
    &IAXSampleCtl_table[-3],
    CStdStubBuffer_DELEGATING_METHODS
};


/* Object interface: ITestCtl, ver. 0.0,
   GUID={0xB68D04E3,0x2F7B,0x4565,{0x85,0xA9,0xD9,0x3B,0x7A,0xFE,0x34,0xEC}} */
...
CINTERFACE_PROXY_VTABLE(10) _ITestCtlProxyVtbl = 
{
    &ITestCtl_ProxyInfo,
    &IID_ITestCtl,
    IUnknown_QueryInterface_Proxy,
    ...
    0 /* (void *)-1 /* IDispatch::GetIDsOfNames */ ,
    0 /* IDispatch_Invoke_Proxy */ ,
    (void *)-1 /* ITestCtl::get_OnState */ ,
    (void *)-1 /* ITestCtl::put_OnState */ ,
    (void *)-1 /* ITestCtl::test */
};
...
/* 270 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 272 */	NdrFcShort( 0x3e4 ),	/* Type Offset=996 */
...
/* 326 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 328 */	NdrFcShort( 0x3ee ),	/* Type Offset=1006 */
...
/* 354 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 356 */	NdrFcShort( 0x166 ),	/* Type Offset=358 */
...
/* 362 */	0x8,		/* FC_LONG */
	...
	/* Procedure get_OnState */

/* 364 */	0x33,		/* FC_AUTO_HANDLE */
			0x6c,		/* Old Flags:  object, Oi2 */
/* 366 */	NdrFcLong( 0x0 ),	/* 0 */
/* 370 */	NdrFcShort( 0x7 ),	/* 7 */
#ifndef _ALPHA_
...
/* 382 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 384 */	NdrFcShort( 0x3ee ),	/* Type Offset=1006 */
...
/* 410 */	NdrFcShort( 0x4 ),	/* x86, MIPS, PPC Stack size/offset = 4 */
			...
			NdrFcShort( 0x8 ),	/* Alpha Stack size/offset = 8 */
#endif
/* 412 */	NdrFcShort( 0x166 ),	/* Type Offset=358 */
...
/* 54 */	
			0x11, 0x4,	/* FC_RP [alloced_on_stack] */
/* 56 */	NdrFcShort( 0x3ac ),	/* Offset= 940 (996) */
/* 58 */	
			0x13, 0x0,	/* FC_OP */
/* 60 */	NdrFcShort( 0x394 ),	/* Offset= 916 (976) */
/* 62 */	
...
/* 588 */	0x13, 0x0,	/* FC_OP */
/* 590 */	NdrFcShort( 0x182 ),	/* Offset= 386 (976) */
/* 592 */	
			0x5b,		/* FC_END */
...
/* 990 */	0x4c,		/* FC_EMBEDDED_COMPLEX */
			0x0,		/* 0 */
/* 992 */	NdrFcShort( 0xfffffc5e ),	/* Offset= -930 (62) */
/* 994 */	0x5c,		/* FC_PAD */
			0x5b,		/* FC_END */
...
/* 1004 */	NdrFcShort( 0xfffffc4e ),	/* Offset= -946 (58) */
/* 1006 */	
			0x11, 0x10,	/* FC_RP */
/* 1008 */	NdrFcShort( 0xfffffd76 ),	/* Offset= -650 (358) */

			0x0
        }
    };

const CInterfaceProxyVtbl * _AXSample_ProxyVtblList[] = 
{
    ( CInterfaceProxyVtbl *) &_IAXSampleCtlProxyVtbl,
    ( CInterfaceProxyVtbl *) &_ITestCtlProxyVtbl,
    0
};

const CInterfaceStubVtbl * _AXSample_StubVtblList[] = 
{
    ( CInterfaceStubVtbl *) &_IAXSampleCtlStubVtbl,
    ( CInterfaceStubVtbl *) &_ITestCtlStubVtbl,
    0
...
PCInterfaceName const _AXSample_InterfaceNamesList[] = 
{
    "IAXSampleCtl",
    "ITestCtl",
    0
...
const IID *  _AXSample_BaseIIDList[] = 
{
    &IID_IDispatch,
    &IID_IDispatch,
    0
...
#define _AXSample_CHECK_IID(n)	IID_GENERIC_CHECK_IID( _AXSample, pIID, n)

int __stdcall _AXSample_IID_Lookup( const IID * pIID, int * pIndex )
{
    IID_BS_LOOKUP_SETUP

    IID_BS_LOOKUP_INITIAL_TEST( _AXSample, 2, 1 )
    IID_BS_LOOKUP_RETURN_RESULT( _AXSample, 2, *pIndex )
    
}

const ExtendedProxyFileInfo AXSample_ProxyFileInfo = 
{
    (PCInterfaceProxyVtblList *) & _AXSample_ProxyVtblList,
    (PCInterfaceStubVtblList *) & _AXSample_StubVtblList,
    (const PCInterfaceName * ) & _AXSample_InterfaceNamesList,
    (const IID ** ) & _AXSample_BaseIIDList,
    & _AXSample_IID_Lookup, 
    2,
    2,
